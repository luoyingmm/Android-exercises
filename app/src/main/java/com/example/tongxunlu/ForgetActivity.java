...
//                User user = query(account, phone);
                ...
                if (password == null){
                    Toast.makeText(this, "你输入的账号和手机号不匹配", Toast.LENGTH_SHORT).show();
                }else {
//                    Toast.makeText(this, "你的密码是" + user.getPassword(), Toast.LENGTH_LONG).show();
                    ...
                    builder.setTitle("系统提示").setMessage("你的密码是『" + password + "』").setPositiveButton("好的", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dyialogInterface, int i) {
