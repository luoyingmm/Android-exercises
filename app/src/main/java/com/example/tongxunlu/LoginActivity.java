...
//        String passowrd = sp.getString("password", null);
//        System.out.println(passowrd);
//        if (account != null && passowrd != null){
//            et_account.setText(account);
//            et_password.setText(passowrd);
//        }
...
//                if (et_account.getText().equals(sp.getString("account",null)) && et_account.getText().equals(sp.getString("password",null)) && sp.getString("account",null) != null){
//                    //把数据打包到User对象中
//                    User bean = new User(sp.getString("account",null),sp.getString("password",null),sp.getString("phone",null));
//                    //添加到集合中
//                    LoginActivity.list.add(bean);
//
////                    list.add(sp.getString("account",null));
